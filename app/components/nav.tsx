  ...
  return (
    ...
    >
      ...
      <div className="flex-none gap-2">
        ...
        <button onClick={handleProfileNavigation} className="btn btn-ghost btn-circle">
          <FaUser />
        </button>
