  ...
  const [error, setError] = useState(null);
    ...
    useEffect(() => {
        const fetchPostData = async () => {
            ...
            try {
                const response = await fetch(`${serverUrl}/group/post/${postid}`, {
                    method: 'GET',
                    credentials: 'include',
                });
                    ...
                    <div className={`card shadow-xl ${isDarkMode ? "bg-gray-800" : "bg-base-100"}`}>
                        <div className="card-body">
                            ...
                            <div className="flex items-center mb-4">
                                {post.author_image && (
                                    <img src={`${serverUrl}/uploads/${post.author_image}`} alt={`${post.author_name}`} className="rounded-full w-12 h-12 mr-3" />
                                )}
                                <div>
                                    <h2 
